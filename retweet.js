...
window.RetweetJS = {
	...
	styling: "a.retweet { font: 10px Helvetica,Arial; color: #000; text-decoration: none; border: 0px; }" +
		...
		"a.retweet strong.vert { display: block; margin-bottom: 4px; background: #94CC3D; border: 1px solid #EEE; -moz-border-radius: 3px; -webkit-border-radius: 3px; border-radius: 3px; padding: 3px; }" +
		"a.retweet span.vert { display: block; font-size: 10px; margin-left: 0px; }" +
		"a.retweet span:hover { background: #fff; color: #94CC3D;}"
};
